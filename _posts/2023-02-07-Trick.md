...
author: 
date: 2023-02-07
img_path: /assets/img/commons/Trick/trick.png
...
![web]({{ '/assets/img/commons/Trick/web.png' | relative_url }}){: .center-image }
_web_
...
![nslookup]({{ '/assets/img/commons/Trick/dns.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/dns1.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/dns2.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/dns3.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/web1.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/web2.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/fuzz.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/dns4.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/web3.png' | relative_url }}){: .center-image }

intentando el Local File inclusion(LFI) no vemos nada pero esa ruta puede existir ya que  nos muestra vacio el contenido
![]({{ '/assets/img/commons/Trick/web4.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal1.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal2.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal3.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal4.png' | relative_url }}){: .center-image }

![]({{ '/assets/img/commons/Trick/terminal5.png' | relative_url }}){: .center-image }
...
![]({{ '/assets/img/commons/Trick/terminal6.png' | relative_url }}){: .center-image }
